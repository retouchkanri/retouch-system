...
export async function PATCH(req: Request, { params }: { params: { id: string } }) {
  ...
  try {
    ...
    if (existingItemId) {
      ...
      // imported before Stripe billing was connected for this contract) —
      // self-heal by creating the item now instead of failing outright with
      // "item_missing" on every edit attempt.
